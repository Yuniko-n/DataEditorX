...
LOCATION_PUBLIC		=0x3c		--（DEOPro）--LOCATION_ONFIELD+LOCATION_GRAVE+LOCATION_REMOVED
LOCATION_ALL		=0x3ff		--（DEOPro）
...
SEQ_DECKTOP			=0			--（DEOPro）
SEQ_DECKBOTTOM		=1			--（DEOPro）
SEQ_DECKSHUFFLE		=2			--（DEOPro）
--Positions 表示形式
...
TYPE_SKILL			=0x8000000	--（DEOPro）
TYPE_ACTION			=0x10000000	--（DEOPro）
TYPES_TOKEN			=TYPE_MONSTER+TYPE_NORMAL+TYPE_TOKEN			--（DEOPro）
TYPE_EXTRA			=TYPE_FUSION+TYPE_SYNCHRO+TYPE_XYZ+TYPE_LINK	--（DEOPro）
--Attributes 属性
...
RACE_WINGEDBEAST	=0x200		--（DEOPro）鸟兽
RACE_PLANT			=0x400		--植物
...
RACE_PSYCHIC		=0x100000	--（DEOPro）念动力
...
ASSUME_ATTACK		=7
ASSUME_DEFENSE		=8
ASSUME_LINK         =9  --（DEOPro）
ASSUME_LINKMARKER   =10 --（DEOPro）
--Link Marker
...
RESETS_STANDARD_DISABLE		=RESETS_STANDARD|RESET_DISABLE	--（DEOPro）
RESETS_REDIRECT				=(RESETS_STANDARD|RESET_OVERLAY)&~(RESET_TOFIELD|RESET_LEAVE) --(EFFECT_LEAVE_FIELD_REDIRECT)
RESETS_CANNOT_ACT			=RESETS_STANDARD&~RESET_LEAVE	--（DEOPro）
...
EFFECT_FLAG2_MAJESTIC_MUST_COPY	=0x80000000	--（DEOPro）
...
EFFECT_QP_ACT_IN_SET_TURN		=19		--（DEOPro）
...
EFFECT_LIGHT_OF_INTERVENTION	=38		--（DEOPro）--神圣光辉（魔术礼帽）
...
EFFECT_GEMINI_STATUS			=75		--（DEOPro）--二重状态
EFFECT_EQUIP_LIMIT				=76		--装备对象限制
EFFECT_DUAL_SUMMONABLE			=77		--可以再度召唤
EFFECT_GEMINI_SUMMONABLE		=77		--（DEOPro）--可以再度召唤
...
EFFECT_CHANGE_BATTLE_STAT		=198	--（DEOPro）
...
EFFECT_CANNOT_BE_MATERIAL			=248--（DEOPro）
...
EFFECT_FORCE_MZONE				=265	--（DEOPro）
EFFECT_BECOME_LINKED_ZONE		=266	--（DEOPro）
...
EFFECT_MUST_BE_MATERIAL			=312	--（DEOPro）--必须作为同调素材（波动龙 声子龙）
...
EFFECT_REMOVE_SETCODE			=349	--（DEOPro）
EFFECT_REMOVE_FUSION_ATTRIBUTE	=350	--reserve
EFFECT_CHANGE_SETCODE			=350	--（DEOPro）
...
EFFECT_EXTRA_MATERIAL			=358	--（DEOPro）
...
EFFECT_EXTRA_TOMAIN_KOISHI					=37564154
EFFECT_OVERLAY_REMOVE_COST_CHANGE_KOISHI	=37564155
EFFECT_ALLOW_SYNCHRO_KOISHI					=37564156
EFFECT_MINIATURE_GARDEN_GIRL				=37564157
EFFECT_ADD_SUMMON_TYPE_KOISHI				=37564158
EFFECT_REMOVE_SUMMON_TYPE_KOISHI			=37564159
EFFECT_CHANGE_SUMMON_TYPE_KOISHI			=37564160
EFFECT_CHANGE_SUMMON_LOCATION_KOISHI		=37564161
EFFECT_LINK_SPELL_KOISHI					=37564162
EFFECT_SEA_PULSE							=37564163
EFFECT_MAP_OF_HEAVEN						=77702007
...
CATEGORY_FLIP				=0x800  	--（DEOPro）--含翻转效果
...
HINT_CARD				=10
HINT_ZONE				=11
HINT_SKILL				=200	--（DEOPro）
HINT_SKILL_COVER		=201	--（DEOPro）
HINT_SKILL_FLIP			=202	--（DEOPro）
HINT_SKILL_REMOVE		=203	--（DEOPro）
...
OPCODE_BAND				=0x40000008	--（DEOPro）
OPCODE_BOR				=0x40000009	--（DEOPro）
OPCODE_BNOT				=0x40000010	--（DEOPro）
OPCODE_BXOR				=0x40000011	--（DEOPro）
OPCODE_LSHIFT			=0x40000012	--（DEOPro）
OPCODE_RSHIFT			=0x40000013	--（DEOPro）
...
OPCODE_GETCODE			=0x40000105	--（DEOPro）
OPCODE_GETSETCARD		=0x40000106	--（DEOPro）
OPCODE_GETTYPE			=0x40000107	--（DEOPro）
OPCODE_GETRACE			=0x40000108	--（DEOPro）
OPCODE_GETATTRIBUTE		=0x40000109	--（DEOPro）
...
HINTMSG_NUMBER			=565	--（DEOPro）
HINTMSG_EFFACTIVATE		=566	--（DEOPro）
HINGMSG_LVRANK			=567	--请宣言一个等级
HINTMSG_LVRANK			=567	--（DEOPro）
...
TIMINGS_CHECK_MONSTER_E     =0x1e0 --（DEOPro）-- 怪兽正面上场 + EP
--Global flag	--特殊标记
...
EFFECT_COUNT_CODE_SINGLE		=0x40000000	--（DEOPro）
--特殊选项
...
--Compost flags for duel modes（DEOPro）
