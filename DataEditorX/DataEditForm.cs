...
namespace DataEditorX
{
	public partial class DataEditForm : DockContent, IDataForm
	{
		...
		void DataEditFormLoad(object sender, EventArgs e)
		{
			...
			//读取PNG图片
			this.menuitem_readPNG.Checked = MyConfig.ReadBoolean(MyConfig.TAG_READ_PNG);
			//自动检查更新
		...
		void Menuitem_aboutClick(object sender, EventArgs e)
		{
			MyMsg.Show(
				...
				+ LanguageHelper.GetMsg(LMSG.Author) + "\tYuniko-n");
		}
		...
		{
			this.menuitem_readPNG.Checked = !this.menuitem_readPNG.Checked;
			XMLReader.Save(MyConfig.TAG_READ_PNG, this.menuitem_readPNG.Checked.ToString().ToLower());
		}
		#endregion
